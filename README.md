...
You have to design & build the backend for the application and the ability for the users to register, publish, search and book rides.
...
https://github.com/azaylamba/blablacar 
